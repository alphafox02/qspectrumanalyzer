...
class Ui_QSpectrumAnalyzerBaseline(object):
    def setupUi(self, QSpectrumAnalyzerBaseline):
        ...
        self.label = QtWidgets.QLabel(parent=QSpectrumAnalyzerBaseline)
        self.label.setObjectName("label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.baselineFileEdit = QtWidgets.QLineEdit(parent=QSpectrumAnalyzerBaseline)
        self.baselineFileEdit.setObjectName("baselineFileEdit")
        self.horizontalLayout.addWidget(self.baselineFileEdit)
        self.baselineFileButton = QtWidgets.QToolButton(parent=QSpectrumAnalyzerBaseline)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=QSpectrumAnalyzerBaseline)
