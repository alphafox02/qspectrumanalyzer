...
class Ui_QSpectrumAnalyzerSettings(object):
    def setupUi(self, QSpectrumAnalyzerSettings):
        ...
        self.label_3 = QtWidgets.QLabel(parent=QSpectrumAnalyzerSettings)
        self.label_3.setObjectName("label_3")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_3)
        self.backendComboBox = QtWidgets.QComboBox(parent=QSpectrumAnalyzerSettings)
        ...
        self.label = QtWidgets.QLabel(parent=QSpectrumAnalyzerSettings)
        self.label.setObjectName("label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.executableEdit = QtWidgets.QLineEdit(parent=QSpectrumAnalyzerSettings)
        self.executableEdit.setObjectName("executableEdit")
        self.horizontalLayout.addWidget(self.executableEdit)
        self.executableButton = QtWidgets.QToolButton(parent=QSpectrumAnalyzerSettings)
        ...
        self.label_5 = QtWidgets.QLabel(parent=QSpectrumAnalyzerSettings)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_5)
        self.label_4 = QtWidgets.QLabel(parent=QSpectrumAnalyzerSettings)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_4)
        self.label_2 = QtWidgets.QLabel(parent=QSpectrumAnalyzerSettings)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_2)
        self.waterfallHistorySizeSpinBox = QtWidgets.QSpinBox(parent=QSpectrumAnalyzerSettings)
        ...
        self.deviceEdit = QtWidgets.QLineEdit(parent=QSpectrumAnalyzerSettings)
        self.deviceEdit.setObjectName("deviceEdit")
        self.horizontalLayout_3.addWidget(self.deviceEdit)
        self.deviceHelpButton = QtWidgets.QToolButton(parent=QSpectrumAnalyzerSettings)
        ...
        self.sampleRateSpinBox = QtWidgets.QDoubleSpinBox(parent=QSpectrumAnalyzerSettings)
        ...
        self.bandwidthSpinBox = QtWidgets.QDoubleSpinBox(parent=QSpectrumAnalyzerSettings)
        ...
        self.lnbSpinBox = QtWidgets.QDoubleSpinBox(parent=QSpectrumAnalyzerSettings)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=QSpectrumAnalyzerSettings)
