...
class Ui_QSpectrumAnalyzerPersistence(object):
    def setupUi(self, QSpectrumAnalyzerPersistence):
        ...
        self.label_2 = QtWidgets.QLabel(parent=QSpectrumAnalyzerPersistence)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_2)
        self.decayFunctionComboBox = QtWidgets.QComboBox(parent=QSpectrumAnalyzerPersistence)
        ...
        self.label = QtWidgets.QLabel(parent=QSpectrumAnalyzerPersistence)
        self.label.setObjectName("label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label)
        self.persistenceLengthSpinBox = QtWidgets.QSpinBox(parent=QSpectrumAnalyzerPersistence)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=QSpectrumAnalyzerPersistence)
