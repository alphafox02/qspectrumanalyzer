...
class Ui_QSpectrumAnalyzerSettingsHelp(object):
    def setupUi(self, QSpectrumAnalyzerSettingsHelp):
        ...
        self.helpTextEdit = QtWidgets.QPlainTextEdit(parent=QSpectrumAnalyzerSettingsHelp)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=QSpectrumAnalyzerSettingsHelp)
